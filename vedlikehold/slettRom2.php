...
$sql="SELECT * FROM rom r LEFT JOIN etg e ON r.hotellnavn = e.hotellnavn && r.etgnr = e.etgnr WHERE r.hotellnavn ='".$_REQUEST["hotellnavn"]."' ORDER BY r.hotellnavn, e.etgnr, r.romnr;";
